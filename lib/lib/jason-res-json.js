(function () {
  ...
  function create(config) {
    ...
    function handler(reqProto, resProto, http) {
      ...
      // TODO maybe jsonp
      console.warn('[ WARNING ] backwards INCOMPATIBLE change in API')
      console.warn('[ WARNING ] your CODE is BROKEN')
      console.log(' ');
      console.warn('[ WARNING ] res.json(obj) will now output `{ result: obj, error: false, ... }` rather than mixing in the error and session stuff');
